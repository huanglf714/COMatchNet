...
def calculate_attention_head(ref_embedding, ref_label, prev_embedding, prev_label, epsilon=1e-5):
    # print('1---------', ref_embedding.shape)
    # print('2---------', ref_label.shape)
    # print('3---------', prev_embedding.shape)
    # print('4---------', prev_label.shape)
    ...
    # print('1-1---------', ref_head_pos.shape)
    # print('2-1---------', ref_head_neg.shape)
    # print('3-1---------', prev_head_pos.shape)
    # print('4-1---------', prev_head_neg.shape)
    total_head = torch.cat([ref_head_pos, ref_head_neg, prev_head_pos, prev_head_neg], dim=1)
    # print('-----------------',total_head.shape)
    return total_head
