...
class Configuration():
    def __init__(self):
        self.EXP_NAME = 'resnet101_cfbi_davis'
        ...
        self.PRETRAIN_MODEL = './pretrain_models/deeplabv3_resnet101_coco.pth'
        ...
        self.MODEL_ATTENTION_OUT_DIM = 128
